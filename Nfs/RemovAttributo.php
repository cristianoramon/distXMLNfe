<?php
	...
	//$teste2 = new cGerarXmlNfs("teste4.xml");
	$_dom = new DomDocument();
	//$_dom->load('exemplo.xml');
	$_dom->load('xml/ptc2.xml');	
	...
	$_novo = $_dom->createElement("CPF","erserse/2001");
	altera_no($_dom,$_novo,"id","dadosEmitente");
	...
	*/
	//$_novo = $_dom->createElement("transporta","0521785197");
	/*if(altera_no($_dom,$_novo,"id","fisco",FALSE,TRUE)) {		
		$_novo->removeAttribute("tipo");
	}	
	*/
	echo "<br/><br/>Documento Alterado<br/><br/>";
	$_dom->save('teste5.xml');
	nos($_dom);
