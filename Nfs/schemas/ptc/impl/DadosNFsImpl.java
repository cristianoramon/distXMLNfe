...
public class DadosNFsImpl
    extends ptc.impl.TNFeImpl
    implements ptc.DadosNFs, com.sun.xml.bind.RIElement, com.sun.xml.bind.JAXBObject, ptc.impl.runtime.UnmarshallableObject, ptc.impl.runtime.XMLSerializable, ptc.impl.runtime.ValidatableObject
{
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (ptc.DadosNFs.class);
    }

    public java.lang.String ____jaxb_ri____getNamespaceURI() {
        return "http://www.portalfiscal.inf.br/ptc";
    }
    ...
    public ptc.impl.runtime.UnmarshallingEventHandler createUnmarshaller(ptc.impl.runtime.UnmarshallingContext context) {
        return new ptc.impl.DadosNFsImpl.Unmarshaller(context);
    }

    public void serializeBody(ptc.impl.runtime.XMLSerializer context)
        throws org.xml.sax.SAXException
    {
        context.startElement("http://www.portalfiscal.inf.br/ptc", "dadosNFs");
...
+"q\u0000~\u0000 xq\u0000~\u0000\u001bt\u0000\u0013ptc.TNFe.InfNFeTypet\u0000+http://java.sun.com/jaxb"
...
+"fNFet\u0000\"http://www.portalfiscal.inf.br/nfesq\u0000~\u0000\u000eppsq\u0000~\u0000\u000eq\u0000~\u0000\u0014"
+"psq\u0000~\u0000\u0000q\u0000~\u0000\u0014p\u0000sq\u0000~\u0000\u000eppsq\u0000~\u0000\u0010q\u0000~\u0000\u0014psq\u0000~\u0000\u0015q\u0000~\u0000\u0014pq\u0000~\u0000\u0018q\u0000~\u0000\u001cq\u0000~\u0000"
+"\u001esq\u0000~\u0000\u001ft\u0000\rptc.Signatureq\u0000~\u0000#sq\u0000~\u0000\u0000q\u0000~\u0000\u0014p\u0000sq\u0000~\u0000\u0007ppsq\u0000~\u0000\u0000pp\u0000sq"
+"\u0000~\u0000\u000eppsq\u0000~\u0000\u0010q\u0000~\u0000\u0014psq\u0000~\u0000\u0015q\u0000~\u0000\u0014pq\u0000~\u0000\u0018q\u0000~\u0000\u001cq\u0000~\u0000\u001esq\u0000~\u0000\u001ft\u0000\u0011ptc.Si"
+"gnatureTypeq\u0000~\u0000#sq\u0000~\u0000\u000eppsq\u0000~\u0000\u0015q\u0000~\u0000\u0014pq\u0000~\u0000)q\u0000~\u00009q\u0000~\u0000\u001esq\u0000~\u0000\u001ft\u0000\t"
+"Signaturet\u0000\"http://www.w3.org/2000/09/xmldsig#q\u0000~\u0000\u001esq\u0000~\u0000\u000epps"
+"q\u0000~\u0000\u0015q\u0000~\u0000\u0014pq\u0000~\u0000)q\u0000~\u00009q\u0000~\u0000\u001esq\u0000~\u0000\u001ft\u0000\bdadosNFst\u0000\"http://www.por"
+"talfiscal.inf.br/ptcsr\u0000\"com.sun.msv.grammar.ExpressionPool\u0000\u0000"
...
+"\u0000\u000fq\u0000~\u0000Bq\u0000~\u0000Jq\u0000~\u0000@q\u0000~\u0000\fq\u0000~\u0000Hq\u0000~\u0000$q\u0000~\u0000Oq\u0000~\u0000Tq\u0000~\u0000\tx"));
        ...
        extends ptc.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return ptc.impl.DadosNFsImpl.this;
        }
            ...
            throws org.xml.sax.SAXException
        {
            ...
            while (true) {
                switch (state) {
                    case  0 :
                        if (("dadosNFs" == ___local)&&("http://www.portalfiscal.inf.br/ptc" == ___uri)) {
                    ...
                    case  1 :
                        if (("infNFe" == ___local)&&("http://www.portalfiscal.inf.br/nfe" == ___uri)) {
                            spawnHandlerFromEnterElement((((ptc.impl.TNFeImpl)ptc.impl.DadosNFsImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname, __atts);
                            return ;
                        }
                        break;
                    case  3 :
