...
public class KeyInfoTypeImpl implements ptc.KeyInfoType, com.sun.xml.bind.JAXBObject, ptc.impl.runtime.UnmarshallableObject, ptc.impl.runtime.XMLSerializable, com.sun.xml.bind.marshaller.IdentifiableObject, ptc.impl.runtime.ValidatableObject
{

    protected ptc.X509DataType _X509Data;
    protected java.lang.String _Id;
    public final static java.lang.Class version = (ptc.impl.JAXBVersion.class);
    private static com.sun.msv.grammar.Grammar schemaFragment;

    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (ptc.KeyInfoType.class);
    }

    public ptc.X509DataType getX509Data() {
        return _X509Data;
    }

    public void setX509Data(ptc.X509DataType value) {
        _X509Data = value;
    }
    ...
    public ptc.impl.runtime.UnmarshallingEventHandler createUnmarshaller(ptc.impl.runtime.UnmarshallingContext context) {
        return new ptc.impl.KeyInfoTypeImpl.Unmarshaller(context);
    }
        ...
        throws org.xml.sax.SAXException
    {
        ...
        context.childAsURIs(((com.sun.xml.bind.JAXBObject) _X509Data), "X509Data");
        context.endNamespaceDecls();
        context.childAsAttributes(((com.sun.xml.bind.JAXBObject) _X509Data), "X509Data");
        context.endAttributes();
        context.childAsBody(((com.sun.xml.bind.JAXBObject) _X509Data), "X509Data");
        context.endElement();
    }
...
+".X509DataTypet\u0000+http://java.sun.com/jaxb/xjc/dummy-elementss"
...
+"/2001/XMLSchema-instanceq\u0000~\u0000\u001csq\u0000~\u0000\u001dt\u0000\bX509Datat\u0000\"http://www."
+"w3.org/2000/09/xmldsig#sq\u0000~\u0000\fppsq\u0000~\u0000\u0013q\u0000~\u0000\u0012psq\u0000~\u0000$ppsr\u0000\u001fcom.s"
...
+"\u0000\u0000\u0001\u0002\u0000\u0001Z\u0000\risAlwaysValidxq\u0000~\u0000)q\u0000~\u0000.t\u0000\u0002IDq\u0000~\u00002\u0000q\u0000~\u00004sq\u0000~\u00005q\u0000~\u0000E"
+"q\u0000~\u0000.sq\u0000~\u0000\u001dt\u0000\u0002Idt\u0000\u0000q\u0000~\u0000\u001csr\u0000\"com.sun.msv.grammar.ExpressionPo"
...
+"/msv/grammar/ExpressionPool;xp\u0000\u0000\u0000\u0006\u0001pq\u0000~\u0000\u0005q\u0000~\u0000\u0010q\u0000~\u0000\rq\u0000~\u0000\nq\u0000~\u0000"
+"\"q\u0000~\u0000=x"));
        }
        ...
        extends ptc.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return ptc.impl.KeyInfoTypeImpl.this;
        }
                ...
                switch (state) {
                    case  4 :
                        if (("X509Certificate" == ___local)&&("http://www.w3.org/2000/09/xmldsig#" == ___uri)) {
                            _X509Data = ((ptc.impl.X509DataTypeImpl) spawnChildFromEnterElement((ptc.impl.X509DataTypeImpl.class), 5, ___uri, ___local, ___qname, __atts));
                            return ;
                        }
                        break;
                    case  3 :
